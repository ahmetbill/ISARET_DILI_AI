...
**Ekip:** Anthropic | **Demo:** [huggingface.co/spaces/isiq/asl-intelligence](https://huggingface.co/spaces/isiq/asl-intelligence)
...
İşaret dilleri evrensel değildir; her kültürün kendi sözdizimi ve grameri bulunur. Literatürde açık kaynaklı büyük verilerin **Amerikan İşaret Dili (ASL)** üzerinde yoğunlaşması nedeniyle, bu prototip sistemin model omurgasını ASL alfabesiyle eğittim. 

Ancak kurduğum bu esnek *YOLO11 + Çevrimdışı NLP* mimarisi, yakın gelecekte iki el koordinasyonuna dayalı olan **Türk İşaret Dili (TİD)** veri setleriyle beslenerek yerli ve milli bir erişilebilirlik çözümüne dönüştürülecek şekilde tasarlanmıştır.
...
> **Çevrimiçi Demo:** Kurulum yapmadan doğrudan tarayıcıdan kullanmak için:
> [https://huggingface.co/spaces/isiq/asl-intelligence](https://huggingface.co/spaces/isiq/asl-intelligence)
